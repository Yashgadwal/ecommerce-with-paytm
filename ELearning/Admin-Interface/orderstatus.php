...
<body>
	...
	<div class="">
		<h1 class="hed">Admin Panel<img src="../pic/logo1.png" class="log">
			<h1>
	</div>
	<hr>
	<?php session_start();
	if (isset($_SESSION['name']) == false) { ?><div class="text-center">
			<h1><a href="../login/login.php" style="color:red;">Please Login First</a></h1>
		</div><?php
			} else {
				?>
					...
					<tr>
						...
						<td>
							<form action="Invoice.php" method="post">
								...
								<button type="submit" value="submit" class="btn btn-primary" name="remove_btn">View Detail</button>
							</form>
						</td>
						<td>
						<td>
