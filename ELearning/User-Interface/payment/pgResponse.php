			...
			<div class="billing-content">
				...
				<div>
					...
					if (isset($_POST) && count($_POST) > 0) {
						...
						$stmt = $db->prepare("UPDATE  transcationbook SET PaymentInfo='$details' ,txnStatus='TXN_SUCCESS' , exceptDate='$exp'  , OrderStatus='placed' , DeliveryDate=now() where  OrderId='$ORDERID' ");
						$stmt->execute();
					}
					?>
				</div>
	...
	FROM  orderlist LEFT JOIN product ON  orderlist.Pid=product.id WHERE  orderlist.OrderID='$ORDERID' ");
						...
						?>
							<tr>
								...
								<td>
									<P><?php echo $row['Quantity'] ?>Pies</p>
								</td>
