...
<body>
  ...
  <div class="main-container">
    ...
    $stmt = $db->query("SELECT * FROM product  where display='YES' ORDER BY id DESC");
        ...
        <div class="line-flex">
          ...
          <form action="previewbook.php" method="post">
            ...
            <button type="submit" value="submit" class="btn btn-outline-warning" name="insertCart_btn" style="text-align:center;">
              <i class="fa fa-picture-o"> Preview</i></button>
          </form>
        </div>
        <div class="line-flex">
          <div>
          ...
          <div>
            <button type="submit" name="submit" value="submit" name="insertCart_btn" class="btn btn-success">
              Add <i class="fa fa-shopping-cart" aria-hidden="true"></i></button></form>
          </div>
        </div>
      </div>
